...
for i in range(4):
    ...
    for delta_resource in delta_resources:
        DELTA_RESOURCE = delta_resource                   # factor by which resource assignment is changed due to action
        BETA = beta                              # factor influences how fast support is changed due to interaction
        DELTA_RESEARCH = delta_research                    # factor by which research is changed due to action of FSC
